  ...
  return (
    <div className="w-full bg-white md:rounded-2xl md:border border-gray-200 md:p-4 md:shadow-sm flex overflow-x-auto hide-scrollbar gap-3 md:gap-4 mb-6 pb-2 md:pb-0 -mx-4 px-4 md:mx-0 md:px-0">
      ...
      <div className="flex-none md:flex-1">
        <div className="flex items-center justify-between bg-neutral-100 px-4 py-2 md:py-3 rounded-full md:rounded-xl cursor-pointer hover:bg-gray-200 transition-colors whitespace-nowrap">
          <div className="flex items-center gap-2">
            <Package className="w-4 h-4 text-gray-500" />
            <span className="text-sm font-medium text-gray-800">Semua Komoditas</span>
          </div>
        ...
        <div className="flex items-center justify-between bg-neutral-100 px-4 py-2 md:py-3 rounded-full md:rounded-xl cursor-pointer hover:bg-gray-200 transition-colors whitespace-nowrap">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-gray-800">
              {desaData.length > 0 ? `${desaData.length} Desa Tersedia` : 'Semua Lokasi'}
            </span>
          </div>
      ...
      <div className="flex-none">
        <Button className="h-10 md:h-12 rounded-full md:rounded-xl px-4 md:px-6 bg-primary-dark hover:bg-primary flex items-center gap-2 whitespace-nowrap">
