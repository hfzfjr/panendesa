  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-4 lg:px-8 py-16 border-t border-gray-200">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4 md:gap-0">
        <div>
          <h2 className="text-2xl font-bold text-neutral-900 mb-2">Kapasitas Produksi Desa</h2>
          <p className="text-neutral-600 text-sm">
            Desa dengan performa panen tertinggi dan validasi terverifikasi.
          </p>
        </div>
        <Link href="#" className="flex items-center gap-1 text-sm font-bold text-gray-700 hover:text-primary-dark transition-colors group whitespace-nowrap">
          Lihat Semua Desa
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm font-bold text-primary">{village.trustScore}/100</div>
                </div>
              </div>
              ...
              <div className="space-y-3 mb-8">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold text-primary-dark">{village.valCapacity}</span>
                </div>
                <div className="w-full bg-gray-100 rounded-full h-1.5 overflow-hidden">
                  <div className="bg-primary h-full rounded-full" style={{ width: `${village.trustScore}%` }}></div>
                </div>
              </div>

              <Button variant="outline" className="w-full text-primary-dark border-primary/30 hover:bg-green-50">
                Lihat Katalog
              </Button>
            </div>
          </div>
