  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-4 lg:px-8 py-16 mb-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        {/* Logistik Card */}
        <div className="bg-[#F2F4EF] p-10 rounded-[32px] flex flex-col md:flex-row gap-8 items-start hover:shadow-lg transition-shadow border border-gray-200/50">
          <div className="w-20 h-20 bg-green-200/50 rounded-2xl flex items-center justify-center text-[var(--color-primary-dark)] shrink-0">
            <Truck className="w-10 h-10" />
          </div>
          <div>
            <h3 className="text-2xl font-bold text-[var(--color-primary-dark)] mb-3">Logistik Terintegrasi</h3>
        ...
        {/* Escrow Card */}
        <div className="bg-[#EAE8E3] p-10 rounded-[32px] flex flex-col md:flex-row gap-8 items-start hover:shadow-lg transition-shadow border border-gray-200/50">
          <div className="w-20 h-20 bg-[#D4D2CD] rounded-2xl flex items-center justify-center text-[#5A5752] shrink-0">
            <ShieldCheck className="w-10 h-10" />
          </div>
          <div>
            <h3 className="text-2xl font-bold text-[#5A5752] mb-3">Pembayaran Aman (Escrow)</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
