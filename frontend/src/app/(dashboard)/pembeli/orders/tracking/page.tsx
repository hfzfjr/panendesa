...
export default function OrderTrackingPage() {
  return (
    <main className="max-w-7xl mx-auto px-4 lg:px-8 py-6 md:py-12 pb-28 min-h-screen">
      ...
      <div className="mb-8">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-neutral-900 tracking-tight mb-2">
      ...
      <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-4 md:p-6 shadow-sm overflow-hidden">
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3 mb-6 md:mb-8">
              ...
              <span className="bg-amber-500 text-white text-xs font-bold px-3 py-1.5 rounded shadow-sm w-fit">
            ...
            <div className="relative pb-2 md:pb-6 mt-4">
              ...
              {/* Connecting Line */}
              <div className="absolute top-4 md:top-6 left-[10%] right-[10%] h-0.5 bg-gray-200 -z-10"></div>
              {/* Active Line (Up to step 4) */}
              <div className="absolute top-4 md:top-6 left-[10%] w-[75%] h-0.5 bg-neutral-800 -z-10"></div>

              <div className="flex justify-between text-center relative z-10">

                {/* Step 1 */}
                <div className="flex flex-col items-center flex-1">
                  <div className="w-8 h-8 md:w-12 md:h-12 rounded-full bg-neutral-800 text-white flex items-center justify-center ring-4 md:ring-6 ring-white shadow-sm mb-2 md:mb-3">
                ...
                <div className="flex flex-col items-center flex-1">
                  <div className="w-8 h-8 md:w-12 md:h-12 rounded-full bg-amber-500 text-white flex items-center justify-center ring-4 md:ring-6 ring-white shadow-md mb-2 md:mb-3 relative">
                    <div className="absolute inset-0 rounded-full ring-2 ring-amber-500/30 animate-pulse scale-125"></div>
                ...
                {/* Step 5 (Pending) */}
                <div className="flex flex-col items-center flex-1">
                  <div className="w-8 h-8 md:w-12 md:h-12 rounded-full bg-neutral-100 text-gray-300 flex items-center justify-center ring-4 md:ring-6 ring-white mb-2 md:mb-3">
          ...
          {/* Map Area */}
          <div className="bg-gray-200 rounded-2xl h-48 md:h-72 border border-gray-200 overflow-hidden relative shadow-sm">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
              <div className="w-8 h-8 text-primary-dark animate-bounce">
            ...
            <div className="md:hidden space-y-4">
              ...
              <div className="p-4 border border-gray-100 rounded-xl bg-gray-50/50 flex flex-col gap-3">
                ...
                <div className="flex justify-between items-center text-sm bg-white p-3 rounded-lg border border-gray-100">
                  ...
                  <span className="font-bold text-primary-dark">500 kg</span>
                </div>
              </div>
              ...
              <div className="p-4 border border-gray-100 rounded-xl bg-gray-50/50 flex flex-col gap-3">
                ...
                <div className="flex justify-between items-center text-sm bg-white p-3 rounded-lg border border-gray-100">
                  ...
                  <span className="font-bold text-primary-dark">250 kg</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-4 md:p-6 shadow-sm">
            ...
            <div className="bg-neutral-50 border border-primary-dark/10 rounded-xl p-4 flex gap-4 items-center mb-6">
            ...
            <div className="space-y-3">
              <Button variant="custom" className="w-full h-12 bg-neutral-800 hover:bg-neutral-900 text-white font-bold transition-colors flex items-center justify-center gap-2">
          ...
          <div className="bg-neutral-900 rounded-2xl overflow-hidden shadow-lg border border-gray-800">
            ...
            <div className="p-4 md:p-6 relative">
              {/* Timeline Line */}
              <div className="absolute left-6 md:left-10 top-8 bottom-12 w-px bg-gray-700"></div>

              <div className="space-y-8 relative z-10">
                {/* Current */}
                <div className="flex gap-4 items-start">
                  <div className="mt-1 shrink-0 bg-neutral-900 py-1">
                    <div className="w-4 h-4 rounded-full border-[3px] border-green-400 bg-neutral-900"></div>
                  </div>
                  <div>
