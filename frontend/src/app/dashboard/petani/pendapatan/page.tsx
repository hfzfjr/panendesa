    ...
    <div className="p-4 md:p-8 max-w-4xl mx-auto space-y-6 pb-32 md:pb-8">
      ...
      <div className="bg-[#1B5E20] rounded-3xl p-6 md:p-8 shadow-xl shadow-green-900/20 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight mb-6 break-words leading-tight text-yellow-400">
            Rp 25.500.000
          </div>
      ...
      <div className="flex flex-col md:flex-row gap-3">
        <button 
          ...
          className={`flex-1 py-4 font-black text-lg md:text-xl rounded-2xl border-2 transition-all flex items-center justify-center gap-2 shadow-sm ${filter === "Lunas" ? 'bg-[#1B5E20] text-white border-[#1B5E20]' : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50'}`}
        >
          💰 Sudah Cair
        </button>
        <button 
      ...
      <div className="space-y-4">
        {(filter === "Lunas" || filter === "Semua") && (
          <Link href="/dashboard/petani/pendapatan/detail" className="bg-white rounded-3xl border-2 border-gray-100 hover:border-green-500 transition-colors shadow-sm overflow-hidden flex flex-col md:flex-row items-center md:items-stretch cursor-pointer group block">
            ...
            <div className="p-5 md:p-6 flex-1 flex flex-col justify-between w-full">
              ...
              <div className="mt-4 flex items-end justify-between">
                <div>
                  ...
                  <p className="text-3xl font-black text-[#1B5E20]">Rp 2.779.500</p>
                </div>
                <div className="w-12 h-12 bg-green-50 rounded-full flex items-center justify-center text-[#1B5E20] group-hover:bg-[#1B5E20] group-hover:text-white transition-colors">
          ...
          <Link href="/dashboard/petani/pendapatan/detail" className="bg-white rounded-3xl border-2 border-gray-100 hover:border-green-500 transition-colors shadow-sm overflow-hidden flex flex-col md:flex-row items-center md:items-stretch cursor-pointer group block">
            ...
            <div className="p-5 md:p-6 flex-1 flex flex-col justify-between w-full">
              ...
              <div className="mt-4 flex items-end justify-between">
                <div>
                  <p className="text-sm font-bold text-gray-500 mb-1">Uang Diterima:</p>
                  <p className="text-3xl font-black text-[#1B5E20]">Rp 1.960.000</p>
                </div>
                <div className="w-12 h-12 bg-green-50 rounded-full flex items-center justify-center text-[#1B5E20] group-hover:bg-[#1B5E20] group-hover:text-white transition-colors">
                  <ChevronRight className="w-6 h-6" />
                </div>
        ...
        {(filter === "Proses" || filter === "Semua") && (
          <Link href="/dashboard/petani/pendapatan/detail" className="bg-white rounded-3xl border-2 border-gray-100 hover:border-orange-400 transition-colors shadow-sm overflow-hidden flex flex-col md:flex-row items-center md:items-stretch cursor-pointer group block">
            <div className="w-full md:w-48 h-48 bg-gray-200 relative shrink-0">
              <img 
      ...
      <button className="w-full py-4 font-bold text-[#1B5E20] border-2 border-[#1B5E20] rounded-2xl hover:bg-green-50 transition-colors">
