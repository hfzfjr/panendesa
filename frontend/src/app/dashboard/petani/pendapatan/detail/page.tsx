    ...
    <div className="p-4 md:p-8 max-w-4xl mx-auto space-y-6 pb-32 md:pb-8">
      ...
      <div className="bg-white rounded-3xl border-2 border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="p-6 md:p-8 space-y-4 font-mono text-lg md:text-xl text-gray-800">
          ...
          <div className="flex justify-between items-center py-2 text-[#1B5E20]">
          ...
          <div className="flex justify-between items-center pt-2">
            ...
            <span className="font-black text-3xl md:text-4xl text-[#1B5E20]">Rp 2.779.500</span>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-green-50 border-2 border-green-200 rounded-2xl">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-[#1B5E20] text-white font-black text-xl rounded-full flex items-center justify-center">
                A
              </div>
              <div>
            ...
            <div className="text-right">
              <span className="block font-black text-[#1B5E20] text-xl">Rp 2.779.500</span>
            </div>
          </div>
