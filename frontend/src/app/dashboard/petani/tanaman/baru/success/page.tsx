  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto space-y-8 md:space-y-10 pb-24 md:pb-8 text-center pt-8 md:pt-12">
      <div className="flex flex-col items-center justify-center space-y-4">
        <div className="w-24 h-24 md:w-32 md:h-32 bg-green-100 text-[#1B5E20] rounded-full flex items-center justify-center mb-2 animate-bounce-slow shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
        ...
        <div className="bg-[#1B5E20] rounded-3xl p-6 shadow-xl shadow-green-900/10 text-white flex flex-col h-full relative overflow-hidden">
          ...
          <div className="space-y-6 relative z-10">
            <div className="flex gap-4">
              <div className="w-8 h-8 bg-green-100 text-[#1B5E20] rounded-full flex items-center justify-center font-black shrink-0">1</div>
              <div>
      ...
      <div className="flex flex-col md:flex-row justify-center gap-4 pt-6 max-w-3xl mx-auto">
        <Link 
          ...
          className="flex-1 bg-[#1B5E20] text-white font-bold py-4 px-6 rounded-2xl shadow-lg flex items-center justify-center gap-2 hover:bg-green-800 transition-colors"
        >
          <FileText className="w-5 h-5" />
          <span className="text-lg">Buat Laporan Pertama</span>
        </Link>
        <Link 
          href="/dashboard/petani/tanaman/1" 
          className="flex-1 bg-white text-[#1B5E20] border-2 border-[#1B5E20] font-bold py-4 px-6 rounded-2xl shadow-sm flex items-center justify-center gap-2 hover:bg-green-50 transition-colors"
        >
