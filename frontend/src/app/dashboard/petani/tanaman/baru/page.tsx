      ...
      <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
        <div className="bg-white rounded-3xl p-6 border border-gray-200 shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <button 
              ...
              className={`relative flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border-2 transition-all ${komoditas === "Cabai Merah" ? 'border-[#1B5E20] bg-green-50 ring-4 ring-green-500/20' : 'border-gray-200 hover:border-gray-300 bg-white'}`}
            >
              {komoditas === "Cabai Merah" && (
                <div className="absolute -top-3 bg-[#1B5E20] text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest shadow-sm">Terpilih</div>
              )}
            ...
            <button 
              ...
              className={`relative flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border-2 transition-all ${komoditas === "Bawang Merah" ? 'border-[#1B5E20] bg-green-50 ring-4 ring-green-500/20' : 'border-gray-200 hover:border-gray-300 bg-white'}`}
            >
            ...
            <button 
              ...
              className={`relative flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border-2 transition-all ${komoditas === "Jagung" ? 'border-[#1B5E20] bg-green-50 ring-4 ring-green-500/20' : 'border-gray-200 hover:border-gray-300 bg-white'}`}
            >
              {komoditas === "Jagung" && (
                <div className="absolute -top-3 bg-[#1B5E20] text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest shadow-sm">Terpilih</div>
              )}
            ...
            <button 
              ...
              className={`relative flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border-2 transition-all ${komoditas === "Beras" ? 'border-[#1B5E20] bg-green-50 ring-4 ring-green-500/20' : 'border-gray-200 hover:border-gray-300 bg-white'}`}
            >
              {komoditas === "Beras" && (
                <div className="absolute -top-3 bg-[#1B5E20] text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest shadow-sm">Terpilih</div>
              )}
            ...
            <button 
              ...
              className={`relative flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border-2 transition-all ${komoditas === "Tomat" ? 'border-[#1B5E20] bg-green-50 ring-4 ring-green-500/20' : 'border-gray-200 hover:border-gray-300 bg-white'}`}
            >
              {komoditas === "Tomat" && (
                <div className="absolute -top-3 bg-[#1B5E20] text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest shadow-sm">Terpilih</div>
              )}
            ...
            <button 
              ...
              className={`relative flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border-2 transition-all ${komoditas === "Lainnya" ? 'border-[#1B5E20] bg-green-50 ring-4 ring-green-500/20' : 'border-gray-200 hover:border-gray-300 bg-white'}`}
            >
              {komoditas === "Lainnya" && (
                <div className="absolute -top-3 bg-[#1B5E20] text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest shadow-sm">Terpilih</div>
              )}
        ...
        <div className="bg-white rounded-3xl p-6 border border-gray-200 shadow-sm space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <select className="w-full h-14 bg-gray-50 border-2 border-gray-200 rounded-xl px-4 text-lg font-medium text-gray-900 focus:border-[#1B5E20] focus:ring-0 outline-none transition-colors">
            ...
            <div className="space-y-2">
              ...
              <input 
                type="date" 
                className="w-full h-14 bg-gray-50 border-2 border-gray-200 rounded-xl px-4 text-lg font-medium text-gray-900 focus:border-[#1B5E20] focus:ring-0 outline-none transition-colors"
              />
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                <input 
                  type="number" 
                  placeholder="0.00"
                  className="w-full h-14 bg-gray-50 border-2 border-gray-200 rounded-xl px-4 pr-16 text-lg font-medium text-gray-900 focus:border-[#1B5E20] focus:ring-0 outline-none transition-colors"
                />
            ...
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full h-14 bg-gray-50 border-2 border-gray-200 rounded-xl px-4 text-lg font-medium text-gray-900 focus:border-[#1B5E20] focus:ring-0 outline-none transition-colors placeholder:text-gray-400 placeholder:text-base placeholder:font-normal"
              />
            </div>
            <div className="space-y-2">
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="flex flex-col md:flex-row gap-3">
                <button 
                  ...
                  className={`flex-1 py-4 font-bold text-lg rounded-2xl border-2 transition-all ${metodeTanam === "Organik" ? 'bg-[#1B5E20] text-white border-[#1B5E20] shadow-md' : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50'}`}
                >
                  🌱 Organik
                </button>
                <button 
                  ...
                  className={`flex-1 py-4 font-bold text-lg rounded-2xl border-2 transition-all ${metodeTanam === "Biasa / Kimia" ? 'bg-[#1B5E20] text-white border-[#1B5E20] shadow-md' : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50'}`}
                >
                  🧪 Biasa / Kimia
                </button>
              </div>
            ...
            <div className="space-y-2">
              ...
              <textarea 
                ...
                className="w-full bg-gray-50 border-2 border-gray-200 rounded-xl p-4 text-lg font-medium text-gray-900 focus:border-[#1B5E20] focus:ring-0 outline-none transition-colors placeholder:text-gray-400 placeholder:text-base placeholder:font-normal"
              ></textarea>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-3xl p-6 border border-gray-200 shadow-sm space-y-6">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <button 
              ...
              className={`flex-1 py-4 font-bold text-lg rounded-2xl border-2 transition-all ${pengingat === "3 Hari" ? 'bg-[#1B5E20] text-white border-[#1B5E20] shadow-md' : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50'}`}
            >
              Setiap 3 Hari
            </button>
            <button 
              ...
              className={`flex-1 py-4 font-bold text-lg rounded-2xl border-2 transition-all ${pengingat === "5 Hari" ? 'bg-[#1B5E20] text-white border-[#1B5E20] shadow-md' : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50'}`}
            >
              Setiap 5 Hari
            </button>
            <button 
              ...
              className={`flex-1 py-4 font-bold text-lg rounded-2xl border-2 transition-all ${pengingat === "7 Hari" ? 'bg-[#1B5E20] text-white border-[#1B5E20] shadow-md' : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50'}`}
            >
              Setiap 7 Hari
            </button>
          </div>
        ...
        <div className="fixed bottom-0 left-0 right-0 md:static bg-white md:bg-transparent border-t md:border-none border-gray-200 p-4 md:p-0 z-40 md:flex md:justify-end md:gap-4 md:mt-8 pb-safe shadow-[0_-10px_20px_-10px_rgba(0,0,0,0.1)] md:shadow-none">
          <div className="flex flex-col-reverse md:flex-row gap-3 max-w-4xl mx-auto w-full md:w-auto">
            ...
            <button className="w-full md:w-auto flex items-center justify-center gap-2 py-4 px-10 font-bold text-white bg-[#1B5E20] hover:bg-green-800 rounded-2xl transition-colors shadow-lg">
