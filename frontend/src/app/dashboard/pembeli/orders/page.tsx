      ...
      <div className="space-y-4">
        {filteredOrders.length > 0 ? (
            ...
            <div key={order.id} className="bg-white rounded-2xl border border-gray-200 p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-bold text-[#1B5E20]">{order.price}</p>
                </div>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-100 flex justify-end gap-3">
                {order.status === "Selesai" ? (
                  <>
                    ...
                    <Link href={`/dashboard/pembeli/orders/completed`}>
                      <Button className="px-6 py-2 h-10 rounded-xl bg-[var(--color-primary-dark)] hover:bg-[var(--color-primary)] text-white font-bold text-sm transition-colors">
                        Lihat Detail
                      </Button>
                    </Link>
                  </>
                  ...
                  <>
                    ...
                    <Link href={`/dashboard/pembeli/orders/tracking`}>
                      <Button className="px-6 py-2 h-10 rounded-xl bg-[var(--color-primary-dark)] hover:bg-[var(--color-primary)] text-white font-bold text-sm transition-colors">
                        Lacak Pesanan
                      </Button>
                    </Link>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-8 md:p-12 text-center flex flex-col items-center">
            ...
            <Link href="/dashboard/pembeli/marketplace">
              <Button className="px-8 h-12 rounded-xl bg-[var(--color-primary-dark)] hover:bg-[var(--color-primary)] text-white font-bold transition-colors">
                Mulai Belanja
              </Button>
            </Link>
          </div>
