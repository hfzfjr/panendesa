      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 md:p-6">
            <h3 className="font-bold text-gray-900 flex items-center gap-2 text-lg mb-6">
              <PackageCheck className="w-6 h-6 text-[#1B5E20]" />
              Ringkasan Penerimaan
            </h3>
            ...
            {/* Item List */}
            <div className="bg-[#F2F7F2] border border-[#1B5E20]/10 rounded-xl p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              ...
              <div className="font-bold text-[#1B5E20] text-sm bg-white px-3 py-1.5 rounded-lg shadow-sm border border-[#1B5E20]/10">
                Lolos QC
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 md:p-6">
            ...
            <div className="border border-gray-200 rounded-xl p-4 md:p-5 mb-6">
              ...
              <textarea 
                className="w-full bg-[#F9FAFB] border border-gray-200 rounded-xl p-4 text-sm focus:outline-none focus:ring-2 focus:ring-[#1B5E20]/50"
                rows={3}
            ...
            <Button className="w-full h-12 rounded-xl bg-[var(--color-primary-dark)] hover:bg-[var(--color-primary)] text-white font-bold transition-colors">
              Kirim Penilaian
            </Button>
          </div>

          {/* Dampak Positif */}
          <div className="bg-gradient-to-br from-[#1B5E20] to-[#2E7D32] rounded-2xl p-5 md:p-6 text-white flex gap-4 items-start relative overflow-hidden shadow-md">
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="bg-[#1B5E20] px-4 md:px-5 py-4 flex justify-between items-center">
            ...
            <div className="p-4 md:p-5">
              ...
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="bg-[#1B5E20] text-white text-[10px] font-bold px-2 py-1 rounded">LUNAS</span>
              </div>
              <div className="font-extrabold text-[#1B5E20] text-2xl">
                Rp 12.500.000
              </div>
            </div>
          </div>

          <Button variant="custom" className="w-full h-12 rounded-xl bg-white border border-[#1B5E20] text-[#1B5E20] hover:bg-[#F2F7F2] font-bold transition-colors flex items-center justify-center gap-2">
            <Download className="w-4 h-4" />
            Unduh Invoice (PDF)
          </Button>

          <Link href="/dashboard/pembeli" className="block w-full">
          ...
          {/* Guarantee Box */}
          <div className="bg-[#F2F7F2] rounded-xl border border-[#1B5E20]/10 p-4">
            <div className="flex items-center gap-1 mb-2">
              <ShieldCheck className="w-4 h-4 text-[#1B5E20]" />
              <h4 className="font-bold text-[#1B5E20] text-xs">SafePanenDesa Guaranteed</h4>
            </div>
