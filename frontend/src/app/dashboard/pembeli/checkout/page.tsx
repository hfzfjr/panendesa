  ...
  return (
    ...
    <main className="max-w-7xl mx-auto px-4 lg:px-8 py-6 md:py-12 pb-28">
      ...
      <div className="flex items-center gap-3 mb-6 md:mb-8">
        <Link href="/dashboard/pembeli/cart" className="p-2 hover:bg-gray-100 rounded-full transition-colors -ml-2">
          <ArrowLeft className="w-6 h-6 text-gray-800" />
        </Link>
        <div className="flex flex-col">
          <h1 className="text-xl md:text-3xl font-extrabold text-[#1A1C19] tracking-tight">
            Checkout Pesanan
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
              <div className="bg-[#F4F6F1] px-6 py-4 flex items-center gap-2 font-bold text-[var(--color-primary-dark)] border-b border-gray-200">
              ...
              <div className="bg-[#F8F9F6] px-6 py-3 border-t border-gray-100 flex gap-2 text-xs text-gray-500 items-start">
            ...
            {/* Escrow Banner */}
            <div className="bg-[#F2F7F2] rounded-2xl border border-green-900/10 p-6 flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 sm:gap-6">
              ...
              <div>
                <div className="flex flex-col sm:flex-row items-center gap-2 mb-2 sm:mb-1">
                  <h3 className="font-bold text-[var(--color-primary-dark)]">PanenDesa Escrow Protection</h3>
                  <span className="bg-[var(--color-primary)] text-white text-[8px] font-bold px-1.5 py-0.5 rounded uppercase">Official</span>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                ...
                <div className="p-6 space-y-4 text-sm">
                  ...
                  <div className="flex justify-between items-center pt-2">
                    ...
                    <span className="text-lg font-bold text-[var(--color-primary-dark)]">Rp 8.275.000</span>
                  </div>
                ...
                <div className="border-t border-gray-100 p-6 pt-4 bg-gray-50/50">
                  ...
                  <div className="space-y-3">
                    {/* Option 1 */}
                    <label className="flex items-start gap-3 p-4 rounded-xl border-2 border-[var(--color-primary)] bg-[#F8FAF6] cursor-pointer relative">
                      <input type="radio" name="payment" className="mt-1 w-4 h-4 text-[var(--color-primary)]" defaultChecked />
                      <div>
                      ...
                      <div className="absolute top-3 right-3 bg-[var(--color-primary-dark)] text-white text-[8px] font-bold px-2 py-1 rounded uppercase tracking-wider">
                        Rekomendasi
                      </div>
                    </label>
              ...
              <div className="hidden lg:block space-y-3 mt-4">
                <Link href="/dashboard/pembeli/payment" className="block">
                  <Button className="w-full h-14 rounded-xl bg-[var(--color-primary-dark)] hover:bg-[var(--color-primary)] font-bold text-[15px] flex justify-between items-center px-6 transition-colors">
              ...
              <div className="rounded-2xl border border-gray-200 overflow-hidden shadow-sm relative h-48 bg-gray-100 mt-4">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                  <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center shadow-lg transform -translate-x-10 -translate-y-6">
                     <div className="w-6 h-6 rounded-full bg-[var(--color-primary)] text-white flex items-center justify-center text-[10px] font-bold">PB</div>
                  </div>
                  <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center shadow-lg transform translate-x-12 translate-y-4">
                     <div className="w-6 h-6 rounded-full bg-[var(--color-primary)] text-white flex items-center justify-center text-[10px] font-bold">PA</div>
                  </div>
                  <div className="w-8 h-8 rounded-full bg-[var(--color-primary-dark)] text-white flex items-center justify-center shadow-lg">
      ...
      <div className="lg:hidden fixed bottom-[64px] left-0 w-full bg-white border-t border-gray-200 p-4 z-40 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
        <div className="flex justify-between items-center mb-3">
          <span className="text-sm font-bold text-gray-600">Total Tagihan</span>
          <span className="text-lg font-black text-[var(--color-primary-dark)]">Rp 2.165.000</span>
        </div>
        <Link href="/dashboard/pembeli/payment" className="block">
          <Button className="w-full h-12 rounded-xl bg-[var(--color-primary-dark)] hover:bg-[var(--color-primary)] font-bold text-[15px] flex justify-center items-center transition-colors">
            Bayar Sekarang
          </Button>
        </Link>
      </div>
