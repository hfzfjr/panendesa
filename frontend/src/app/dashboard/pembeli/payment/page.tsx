...
export default function PaymentPage() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 lg:px-8 py-8 md:py-12">
        ...
        {/* Back Button */}
        <Link href="/dashboard/pembeli/checkout" className="inline-flex items-center gap-2 text-gray-700 hover:text-[var(--color-primary-dark)] font-medium mb-8 transition-colors">
        ...
        <div className="mb-6 md:mb-8">
          <h1 className="text-2xl md:text-4xl font-bold text-[#1A1C19] tracking-tight mb-2 md:mb-4">
            Pembayaran
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            {/* Status Header */}
            <div className="bg-[#FFF5F5] rounded-t-2xl border-b-2 border-red-100 p-4 flex justify-between items-center text-sm font-bold text-[#D32F2F]">
              <div className="flex items-center gap-2">
                <Clock className="w-4 h-4" />
                MENUNGGU PEMBAYARAN
              </div>
              <div className="text-gray-500 font-medium flex items-center gap-2">
                Batas Waktu: <span className="text-[#D32F2F] font-bold">{formatTime(timeLeft)}</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-b-2xl rounded-t-none -mt-6 border border-t-0 border-gray-200 p-8 flex flex-col items-center justify-center shadow-sm">
              ...
              <div className="flex items-center gap-3 mb-4">
                <span className="text-4xl md:text-5xl font-extrabold text-[var(--color-primary-dark)]">Rp 8.275.000</span>
                <button className="text-[var(--color-primary)] hover:text-[var(--color-primary-dark)] transition-colors p-2 rounded-full hover:bg-green-50">
                  <Copy className="w-6 h-6" />
                </button>
              </div>
              <div className="bg-green-50 text-[var(--color-primary-dark)] text-xs font-semibold px-4 py-2 rounded-full flex items-center gap-2">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm mt-4">
              ...
              <div className="flex border-b border-gray-200">
                <button 
                  ...
                  className={`flex-1 py-4 text-sm font-bold transition-colors ${activeTab === "transfer" ? "text-[var(--color-primary-dark)] border-b-2 border-[var(--color-primary-dark)] bg-green-50/30" : "text-gray-500 hover:text-gray-700 bg-gray-50/50 hover:bg-gray-100/50"}`}
                >
                  Transfer Bank
                </button>
                <button 
                  onClick={() => setActiveTab("qris")}
                  className={`flex-1 py-4 text-sm font-bold transition-colors ${activeTab === "qris" ? "text-[var(--color-primary-dark)] border-b-2 border-[var(--color-primary-dark)] bg-green-50/30" : "text-gray-500 hover:text-gray-700 bg-gray-50/50 hover:bg-gray-100/50"}`}
                >
                  QRIS
                </button>
              </div>
                  ...
                  <div className="flex flex-col gap-6 animate-in fade-in duration-300">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center justify-between bg-[#F8FAF6] border border-gray-200 rounded-xl px-4 py-3">
                          <span className="text-xl font-bold tracking-widest text-gray-900">8809 1234 5678</span>
                          <button className="text-[10px] font-bold text-[var(--color-primary-dark)] flex items-center gap-1 hover:text-[var(--color-primary)] uppercase">
              ...
              {activeTab === "transfer" ? (
                <ul className="space-y-4">
                  <li className="flex gap-3 text-sm text-gray-600">
                    <span className="w-6 h-6 rounded-full bg-[var(--color-primary)] text-white flex items-center justify-center font-bold shrink-0 text-xs shadow-sm shadow-green-900/20">1</span>
                    <p className="mt-1">Buka aplikasi Mobile Banking pilihan Anda dan login.</p>
                  </li>
                  <li className="flex gap-3 text-sm text-gray-600">
                    <span className="w-6 h-6 rounded-full bg-[var(--color-primary)] text-white flex items-center justify-center font-bold shrink-0 text-xs shadow-sm shadow-green-900/20">2</span>
                  ...
                  <li className="flex gap-3 text-sm text-gray-600">
                    <span className="w-6 h-6 rounded-full bg-[var(--color-primary)] text-white flex items-center justify-center font-bold shrink-0 text-xs shadow-sm shadow-green-900/20">3</span>
                    <p className="mt-1">Masukkan nomor Virtual Account <span className="font-bold text-gray-800">8809 1234 5678</span>.</p>
                  </li>
                  <li className="flex gap-3 text-sm text-gray-600">
                    <span className="w-6 h-6 rounded-full bg-[var(--color-primary)] text-white flex items-center justify-center font-bold shrink-0 text-xs shadow-sm shadow-green-900/20">4</span>
            ...
            <div className="hidden lg:flex items-center gap-4 mt-4">
              <Link href="/dashboard/pembeli/payment/success" className="w-full sm:w-auto">
                <Button className="w-full h-12 rounded-xl bg-[var(--color-primary-dark)] hover:bg-[var(--color-primary)] font-bold px-8 transition-colors">
                  Cek Status Pembayaran
                </Button>
              </Link>
              <Link href="/dashboard/pembeli/marketplace" className="text-sm font-medium text-gray-500 hover:text-[var(--color-primary-dark)]">
          ...
          <div className="lg:col-span-1">
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                <div className="bg-[#1B5E20] text-white px-6 py-4 flex justify-between items-center">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between items-center text-gray-900 font-bold">
                      <span>Kode Unik</span>
                      <span className="text-[var(--color-primary-dark)]">+Rp 500</span>
                    </div>
                    
                    <div className="flex justify-between items-center pt-3 mt-3 border-t border-gray-100">
                      <span className="text-sm font-bold text-gray-700">Total</span>
                      <span className="text-base font-bold text-[var(--color-primary-dark)]">Rp 8.275.000</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Escrow Shield Right */}
              <div className="bg-[#F2F7F2] rounded-2xl border border-green-900/10 p-5 flex flex-col gap-3 text-center sm:text-left sm:flex-row items-center sm:items-start">
                <div className="shrink-0">
                  <CheckCircle className="w-6 h-6 text-[#2E7D32]" />
                </div>
                <div>
                  <h4 className="font-bold text-[#1B5E20] text-sm mb-1">Secure Escrow Protection</h4>
              ...
              <div className="text-center pt-4">
                ...
                <Link href="#" className="text-sm font-bold text-[var(--color-primary-dark)] hover:text-[var(--color-primary)] flex items-center justify-center gap-1">
              ...
              <div className="flex lg:hidden flex-col gap-4 mt-6 pt-4 border-t border-gray-100">
                ...
                <Link href="/dashboard/pembeli/marketplace" className="text-sm font-medium text-gray-500 hover:text-[var(--color-primary-dark)] text-center">
                  Kembali ke Marketplace
                </Link>
              </div>
