...
export default function PaymentSuccessPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 lg:px-8 pt-8 pb-28 md:py-16 lg:py-24 flex flex-col items-center justify-center min-h-screen md:min-h-[80vh]">
      ...
      {/* Success Icon */}
      <div className="w-24 h-24 rounded-full bg-[#1B5E20]/5 flex items-center justify-center mb-6">
        <div className="w-16 h-16 rounded-full bg-[#1B5E20] text-white flex items-center justify-center shadow-lg shadow-green-900/20">
          <Check className="w-8 h-8 stroke-[3]" />
        </div>
      </div>

      {/* Header */}
      <h1 className="text-2xl md:text-4xl font-bold text-[#1B5E20] mb-3 text-center">
        Pembayaran Berhasil!
      </h1>
      ...
      <div className="w-full bg-white rounded-2xl border border-gray-200 shadow-sm p-6 md:p-8 mb-6">
        ...
        <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center gap-4 mb-6 pb-6 border-b border-gray-100">
          ...
          <div className="md:text-right">
            ...
            <div className="font-extrabold text-[#1B5E20] text-xl">Rp 8.275.000</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex gap-3 items-center">
            <div className="w-10 h-10 rounded-xl bg-[#1B5E20]/5 flex items-center justify-center text-gray-500 shrink-0 border border-gray-100">
              {/* Dummy QRIS Icon */}
              <svg className="w-5 h-5 text-[#1B5E20]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <div className="flex gap-3 items-center">
            <div className="w-10 h-10 rounded-xl bg-[#1B5E20]/5 flex items-center justify-center text-gray-500 shrink-0 border border-gray-100">
              <svg className="w-5 h-5 text-[#1B5E20]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Next Steps Alert */}
      <div className="w-full bg-[#F2F7F2] rounded-2xl border border-[#1B5E20]/10 p-5 flex gap-4 items-start mb-8">
        <div className="w-6 h-6 rounded-full bg-[#1B5E20] text-white flex items-center justify-center shrink-0 mt-0.5">
      ...
      <div className="w-full flex flex-col sm:flex-row gap-4 mt-2">
        <Link href="/dashboard/pembeli/orders/tracking" className="flex-1 w-full">
          <Button className="w-full h-12 rounded-xl bg-[var(--color-primary-dark)] hover:bg-[var(--color-primary)] text-white font-bold text-sm md:text-base transition-colors flex items-center justify-center gap-2">
            <TruckIcon className="w-5 h-5" />
            Lacak Pesanan
          </Button>
        </Link>

        <Link href="/dashboard/pembeli" className="flex-1 w-full">
