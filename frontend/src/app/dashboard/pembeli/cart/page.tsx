  ...
  return (
    <main className="max-w-7xl mx-auto px-4 lg:px-8 py-6 md:py-12 pb-28 min-h-screen">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <span className="bg-[#1B5E20]/10 text-[#1B5E20] px-3 py-1 rounded-full text-sm font-bold">
          1 Item
        </span>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 md:p-6">
            ...
            <div className="flex items-center gap-2 mb-4 pb-4 border-b border-gray-100">
              <input type="checkbox" className="w-5 h-5 rounded border-gray-300 text-[#1B5E20] focus:ring-[#1B5E20]" defaultChecked />
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex items-start gap-4 flex-1">
                <input type="checkbox" className="w-5 h-5 rounded border-gray-300 text-[#1B5E20] focus:ring-[#1B5E20] mt-1" defaultChecked />
                ...
                <div className="flex flex-col flex-1">
                  ...
                  <p className="font-bold text-[#1B5E20] text-lg">Rp 22.500 <span className="text-xs text-gray-500 font-normal">/ kg</span></p>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 md:p-6 sticky top-24">
            ...
            <div className="flex items-start gap-3 mb-6 pb-6 border-b border-gray-100">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 truncate max-w-[200px]">Jl. Sudirman No. 45, Jakarta Selatan</p>
              </div>
            </div>
            ...
            <div className="space-y-3 mb-6 pb-6 border-b border-gray-100 text-sm">
              ...
              <div className="flex justify-between items-center text-gray-600">
                ...
                <span className="font-semibold text-[#1B5E20]">-Rp 500.000</span>
              </div>
            </div>

            <div className="flex justify-between items-end mb-6">
              <span className="font-bold text-gray-900">Total</span>
              <span className="font-extrabold text-[#1B5E20] text-xl md:text-2xl">Rp 10.750.000</span>
            </div>

            <Link href="/dashboard/pembeli/checkout" className="block w-full">
              <Button className="w-full h-12 lg:h-14 rounded-xl bg-[var(--color-primary-dark)] hover:bg-[var(--color-primary)] text-white font-bold text-base transition-colors shadow-lg shadow-green-900/20">
                Beli (1)
              </Button>
            </Link>
