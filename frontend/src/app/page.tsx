    ...
    <div className="min-h-screen bg-(--color-neutral-100) text-(--color-neutral-900) font-sans selection:bg-(--color-primary) selection:text-(--color-neutral-900) flex flex-col">
      ...
      <main className="grow flex flex-col items-center">
        ...
        <section className="w-full h-screen min-h-175 flex items-center justify-center px-4 lg:px-8 bg-white">
          <div className="w-full max-w-7xl h-[85vh] min-h-137.5 bg-linear-to-br from-(--color-primary) to-(--color-primary-dark) rounded-[40px] overflow-hidden relative shadow-xl flex items-center">
            ...
            <div className="relative z-10 w-full px-8 lg:px-16 grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="hidden lg:flex items-end justify-end h-105 gap-3">
                <div className="w-30 h-60 rounded-t-[40px] overflow-hidden relative shadow-2xl">
                  <img src="/images/hero-tomat.jpg" alt="Ladang" className="object-cover w-full h-full" />
                </div>
                <div className="w-30 h-82.5 rounded-t-[40px] overflow-hidden relative shadow-2xl">
                  <img src="/images/hero-padi.jpg" alt="Panen" className="object-cover w-full h-full" />
                </div>
                <div className="w-30 h-102.5 rounded-t-[40px] overflow-hidden relative shadow-2xl">
        ...
        <section className="w-full max-w-7xl px-4 lg:px-8 py-20 text-center">
          <h2 className="text-3xl font-extrabold text-(--color-primary-dark) mb-16">
            Kenapa PanenDesa?
          </h2>
          <div className="grid md:grid-cols-3 gap-12 lg:gap-24">
            <div className="flex flex-col items-center space-y-4">
              <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center text-(--color-primary)">
        ...
        <section className="w-full max-w-7xl px-4 lg:px-8 py-24 text-center">
          <h2 className="text-3xl font-extrabold text-(--color-neutral-900) mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
              ...
              <p className="text-lg text-(--color-neutral-900) font-medium mb-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-(--color-primary)">Petani Cabai - Sukamaju</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-(--color-primary)">Pembeli B2B</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="faq" className="w-full max-w-3xl px-4 lg:px-8 pb-24 mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-(--color-neutral-900) mb-4">
              Pertanyaan Umum
            </h2>
          </div>
          ...
          <div className="space-y-4 text-left">
            <div className="border border-gray-200 rounded-2xl overflow-hidden bg-white">
              <button className="w-full px-6 py-4 text-left font-bold flex justify-between items-center text-(--color-primary-dark)">
                Apakah PanenDesa gratis?
                <ChevronDown className="w-5 h-5 transform rotate-180" />
              </button>
              <div className="px-6 pb-4 text-sm text-(--color-neutral-600) leading-relaxed border-t border-gray-100 pt-4">
        ...
        <section className="w-full max-w-5xl px-4 lg:px-8 pb-24">
          <div className="bg-(--color-primary-dark) rounded-4xl p-12 text-center text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-accent/10 rounded-full transform -translate-x-1/2 translate-y-1/2 blur-2xl"></div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link href="/auth/register">
                  <Button variant="outline" className="bg-white text-(--color-primary-dark)! hover:bg-gray-100! border-none rounded-full px-8 font-bold">
                    Coba Sekarang
                  </Button>
                </Link>
